...
texresults2 using "../Output/Tables/OLS_Log.txt", texmacro(mpgcoefa) coef(mpg) replace 
*above I use replace instead of append because it is the first time I am referencing my text file in this stata do-file 
texresults2 using "../Output/Tables/OLS_Log.txt", texmacro(weightcoefa) coef(weight) append


*now lets also use the se option to export our standard errors 
texresults2 using "../Output/Tables/OLS_Log.txt", texmacro(mpgpvaluea) pvalue(mpg) append  
texresults2 using "../Output/Tables/OLS_Log.txt", texmacro(weightpvaluea) pvalue(weight) append
...
texresults2 using "../Output/Tables/OLS_Log.txt", texmacro(obsa) result(e(N)) round(0) append
*here I cam also opting to round to zero decimal places 

 
*This is a helpful command to see your results 
cat "../Output/Tables/OLS_Log.txt"
...
texresults2 using "../Output/Tables/OLS_Log.txt", texmacro(mpgcoefb) coef(mpg) round(3) append 
texresults2 using "../Output/Tables/OLS_Log.txt", texmacro(weightcoefb) coef(weight) round(3) append

texresults2 using "../Output/Tables/OLS_Log.txt", texmacro(mpgpvalueb) pvaluez(mpg) round(3) append  
texresults2 using "../Output/Tables/OLS_Log.txt", texmacro(weightpvalueb) pvaluez(weight) round(3) append

texresults2 using "../Output/Tables/OLS_Log.txt", texmacro(obsb) result(e(N)) round(0) append
...
texresults2 using "../Output/Tables/summary_tex.txt", texmacro(pricemean) result(r(mean)) replace
*export the max and min 
texresults2 using "../Output/Tables/summary_tex.txt", texmacro(pricemin) result(r(min)) append
texresults2 using "../Output/Tables/summary_tex.txt", texmacro(pricemax) result(r(max)) append

*view results 
cat "../Output/Tables/summary_tex.txt"
...
texresults2 using "../Output/Tables/summary_tex.txt", texmacro(start) result(0) replace

foreach var in price foreign weight mpg {
	
	sum `var'
	texresults2 using "../Output/Tables/summary_tex.txt", texmacro(`var'mean) result(r(mean)) append
	texresults2 using "../Output/Tables/summary_tex.txt", texmacro(`var'min) result(r(min)) append
	texresults2 using "../Output/Tables/summary_tex.txt", texmacro(`var'max) result(r(max)) append
...
*trick to (re)start a new text file before looping
texresults2 using "../Output/Tables/LongOLS.txt", texmacro(start) result(0) replace

foreach var in mpg weight headroom trunk length turn displacement {
	
	texresults2 using "../Output/Tables/LongOLS.txt", texmacro(`var'coefc) coef(`var') append
	texresults2 using "../Output/Tables/LongOLS.txt", texmacro(`var'pvaluec) pvalue(`var') append
	texresults2 using "../Output/Tables/LongOLS.txt", texmacro(`var'tstatc) tstat(`var') append
	
} 

*view results 
cat "../Output/Tables/LongOLS.txt"
